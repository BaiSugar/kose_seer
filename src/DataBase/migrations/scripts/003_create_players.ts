  ...
  upMySQL(): string[] {
    return [`
      CREATE TABLE IF NOT EXISTS players (
        ...
        map_id INT NOT NULL DEFAULT 515 COMMENT '当前地图ID (515=新手地图)',
        ...
        nono_flag INT NOT NULL DEFAULT 1 COMMENT 'NONO标志',
        nono_power INT NOT NULL DEFAULT 10000 COMMENT 'NONO体力',
        nono_mate INT NOT NULL DEFAULT 10000 COMMENT 'NONO心情',
        nono_iq INT NOT NULL DEFAULT 0 COMMENT 'NONO智商',
        nono_ai INT NOT NULL DEFAULT 0 COMMENT 'NONO AI',
        nono_super_level INT NOT NULL DEFAULT 0 COMMENT 'NONO超能等级',
        nono_bio INT NOT NULL DEFAULT 0 COMMENT 'NONO生物值',
        nono_birth INT NOT NULL DEFAULT 0 COMMENT 'NONO出生时间',
        nono_charge_time INT NOT NULL DEFAULT 0 COMMENT 'NONO充电时间',
        nono_expire INT NOT NULL DEFAULT 0 COMMENT 'NONO过期时间',
        nono_chip INT NOT NULL DEFAULT 0 COMMENT 'NONO芯片',
        nono_grow INT NOT NULL DEFAULT 0 COMMENT 'NONO成长值',
